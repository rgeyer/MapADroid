...
// Copy/Pasted from here https://www.cnx-software.com/2016/11/19/how-to-create-a-bootable-recovery-sd-card-for-amlogic-tv-boxes/
// Compile with `gcc aml-upgrade-package-extract.c -o aml-upgrade-package-extract`
// Then use it to extract contents of a firmware *.img file `./extractor aml_s912_q6330-R-BOX-PRO-3gddr-mac-20161015.img`
